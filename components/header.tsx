...
import { Zap, LogOut, Users, Package, FileText, Settings, Cpu, TrendingUp } from "lucide-react"
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">CTL Optimizer (AI Base)</h1>
              <p className="text-xs text-muted-foreground">Steel Service Centre Coil-to-Line Optimization</p>
            </div>
          </div>
